...
class EditorialDemoFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    private function createEditorial(EntityManagerInterface $em, ?PostType $postType, array $media, array $users, array $terms = []): array
    {
        ...
        $bilingualDefs = [
            [
                'fr' => [
                    'title' => 'Bienvenue sur Aurora — Le CMS headless',
                    'slug' => 'bienvenue-sur-aurora',
                    'excerpt' => 'Découvrez Aurora, le CMS qui unifie contenus multilingues, taxonomies, formulaires et gestion documentaire.',
                    'blocks' => [
                        ['type' => 'header',    'data' => ['text' => 'Un CMS pour tout publier', 'level' => 2]],
                        ['type' => 'paragraph', 'data' => ['text' => "Aurora unifie l'édition de contenu, les taxonomies, les menus, les commentaires, les formulaires et la GED dans un seul espace d'administration. ".self::LOREM]],
                        ...
                        ['type' => 'header',    'data' => ['text' => 'Édition par blocs & multilingue', 'level' => 3]],
                        ['type' => 'paragraph', 'data' => ['text' => "Rédigez vos contenus avec l'éditeur bloc Editor.js, en autant de langues que nécessaire, avec suivi de conflits façon Git. ".self::LOREM]],
                        ['type' => 'header',    'data' => ['text' => 'Types de contenus & taxonomies', 'level' => 3]],
                        ['type' => 'paragraph', 'data' => ['text' => 'Définissez vos propres types de post et organisez-les avec des taxonomies personnalisées, sans quitter votre espace admin. '.self::LOREM]],
                        ['type' => 'image',     'data' => ['file' => ['url' => $u1, 'width' => 1280, 'height' => 720], 'caption' => 'Aurora — gestion des articles', 'withBorder' => false, 'withBackground' => false, 'stretched' => false]],
                        ['type' => 'header',    'data' => ['text' => 'GED & Formulaires', 'level' => 3]],
                        ['type' => 'paragraph', 'data' => ['text' => self::LOREM]],
                    ],
                ],
                'en' => [
                    'title' => 'Welcome to Aurora — The Headless CMS',
                    'slug' => 'welcome-to-aurora',
                    'excerpt' => 'Discover Aurora, the CMS that unifies multilingual content, taxonomies, forms and document management.',
                    'blocks' => [
                        ['type' => 'header',    'data' => ['text' => 'One CMS to publish everything', 'level' => 2]],
                        ['type' => 'paragraph', 'data' => ['text' => self::LOREM]],
