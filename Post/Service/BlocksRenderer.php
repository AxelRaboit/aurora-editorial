...
final readonly class BlocksRenderer
{
    ...
    /**
     * Delegate an unknown block type to a module-contributed renderer (e.g.
     * Ecommerce's 'productGrid'). Returns '' when no module handles it.
     */
     ...
     * fields. Delegates to the shared core sanitizer so the whitelist is
     * identical across every block renderer.
     */
